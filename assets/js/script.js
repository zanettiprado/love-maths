...
function runGame(gameType) {
    ...
    if (gameType === "addition") {
        ...
        displayMultiplayQuestions(num1, num2);
...
/**
 * Gets the current tally of incorret answers from the DOM and increment it by 1. 
 */
...
function displayMultiplayQuestions(operand1, operand2) {
